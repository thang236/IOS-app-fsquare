...
class PaymentCollectionViewCell: UICollectionViewCell {
    @IBOutlet private var paymentView2: UIView!
    @IBOutlet private var paymentView1: UIView!

    @IBOutlet private var checkIcon2: UIImageView!
    @IBOutlet private var checkIcon1: UIImageView!
